...
var OutlineOverlay = /** @class */ (function (_super) {
        ...
        nodes.forEach(function (element) {
            if (element.isHovered || element.isSelected) {
                ...
                if ((nodeSelectedOutline && isSelected) || (hoverOutline && isHovered)) {
                    ...
                    nodeOutline.push(h(Rect, __assign({ className: "lf-outline-node" }, {
                        x: x, y: y, width: width + 10, height: height + 10,
                    }, attributes_1)));
                }
            }
        });
    ...
    OutlineOverlay.prototype.getLineOutline = function (line) {
        ...
        return (h(Rect, __assign({ className: "lf-outline-edge" }, {
    ...
    OutlineOverlay.prototype.getPolylineOutline = function (polyline) {
        ...
        return (h(Rect, __assign({ className: "lf-outline" }, {
            x: x, y: y, width: width, height: height,
        }, style)));
    };
    // 曲线outline
    ...
    OutlineOverlay.prototype.render = function () {
        return (h("g", { className: "lf-outline" },
